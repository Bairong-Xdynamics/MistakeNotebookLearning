...
local experiment_code_path = std.extVar("APPWORLD_EXPERIMENT_CODE_PATH");
{
    ...
    "config": {
        "agent": {
            ...
            "model_config": {
                ...
                "cost_per_token": {"input_cache_hit": 1.5e-06, "input_cache_miss": 1.5e-05, "input_cache_write": 1.875e-05, "output": 7.5e-05},
    ...
    "metadata": {
        "model": {
            "file_name": "claude-opus-4-1-20250805-medium-reasoning",
            "humanized_name": "Claude Opus 4 1 20250805 Medium Reasoning",
