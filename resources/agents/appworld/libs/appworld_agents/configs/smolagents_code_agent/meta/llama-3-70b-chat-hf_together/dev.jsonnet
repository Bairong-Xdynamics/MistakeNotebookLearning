...
local experiment_code_path = std.extVar("APPWORLD_EXPERIMENT_CODE_PATH");
{
    ...
    "config": {
        "model": {
            ...
            "temperature": 0.0,
            "seed": 100,
            "cost_per_token": {"input_cache_hit": 8.8e-07, "input_cache_miss": 8.8e-07, "input_cache_write": 0.0, "output": 8.8e-07},  # NOTE: Not used, need to figure out how to use it.
            "use_cache": false,
        },
        "api_predictor": {
            "mode": "predicted",
    ...
    "metadata": {
        "model": {
            "file_name": "llama-3-70b-chat-hf_together",
            "humanized_name": "Llama 3 70B Chat Hf Together",
            "precise_name": "together_ai/meta-llama/Llama-3-70b-chat-hf",
            "creator": "meta",
            "provider": "together",
        },
        "agent": {
