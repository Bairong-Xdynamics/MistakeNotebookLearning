...
local experiment_code_path = std.extVar("APPWORLD_EXPERIMENT_CODE_PATH");
{
    ...
    "config": {
        "model": {
            ...
            "temperature": 1.0,
            "cost_per_token": {"input_cache_hit": 5e-09, "input_cache_miss": 5e-08, "input_cache_write": 0.0, "output": 4e-07},  # NOTE: Not used, need to figure out how to use it.
            "use_cache": false,
        },
        "api_predictor": {
            "mode": "predicted",
    ...
    "metadata": {
        "model": {
            "file_name": "gpt-5-nano-2025-08-07-minimal-reasoning",
            "humanized_name": "Gpt 5 Nano 2025 08 07 Minimal Reasoning",
            "precise_name": "gpt-5-nano-2025-08-07",
            "creator": "openai",
            "provider": "openai",
        },
        "agent": {
