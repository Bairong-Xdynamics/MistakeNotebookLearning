...
local experiment_code_path = std.extVar("APPWORLD_EXPERIMENT_CODE_PATH");
{
    ...
    "config": {
        "model": {
            ...
            "temperature": 1.0,
            "cost_per_token": {"input_cache_hit": 5e-07, "input_cache_miss": 2e-06, "input_cache_write": 0.0, "output": 8e-06},  # NOTE: Not used, need to figure out how to use it.
            "use_cache": false,
        },
        "api_predictor": {
            "mode": "predicted",
    ...
    "metadata": {
        "model": {
            "file_name": "o3-2025-04-16-medium-reasoning",
            "humanized_name": "O3 2025 04 16 Medium Reasoning",
            "precise_name": "o3-2025-04-16",
            "creator": "openai",
            "provider": "openai",
        },
        "agent": {
