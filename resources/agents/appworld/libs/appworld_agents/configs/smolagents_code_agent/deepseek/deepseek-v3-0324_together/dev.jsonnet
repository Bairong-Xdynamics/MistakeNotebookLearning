...
local experiment_code_path = std.extVar("APPWORLD_EXPERIMENT_CODE_PATH");
{
    ...
    "config": {
        "model": {
            ...
            "temperature": 0.0,
            "seed": 100,
            "cost_per_token": {"input_cache_hit": 1.25e-06, "input_cache_miss": 1.25e-06, "input_cache_write": 0.0, "output": 1.25e-06},  # NOTE: Not used, need to figure out how to use it.
            "use_cache": false,
        },
        "api_predictor": {
            "mode": "predicted",
