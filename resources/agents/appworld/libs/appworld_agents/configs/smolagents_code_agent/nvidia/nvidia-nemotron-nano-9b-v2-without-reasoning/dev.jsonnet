...
local experiment_code_path = std.extVar("APPWORLD_EXPERIMENT_CODE_PATH");
{
    ...
    "config": {
        "model_server": {
            "command": "vllm serve nvidia/NVIDIA-Nemotron-Nano-9B-v2 --max-num-seqs 10 --port {port} --trust-remote-code --mamba_ssm_cache_dtype float32 --enable-auto-tool-choice --tool-call-parser nemotron_json "  + "--tool-parser-plugin " + experiment_code_path + "/common/vllm_plugins/nemotron_toolcall_parser.py ",
            "enabled": true,
            "show_logs": false,
            "timeout": 600
        },
    ...
    "metadata": {
        "model": {
            "file_name": "nvidia-nemotron-nano-9b-v2-without-reasoning",
            "humanized_name": "Nvidia Nemotron Nano 9B V2 Without Reasoning",
            "precise_name": "nvidia/NVIDIA-Nemotron-Nano-9B-v2",
            "creator": "nvidia",
            "provider": "vllm",
        },
        "agent": {
