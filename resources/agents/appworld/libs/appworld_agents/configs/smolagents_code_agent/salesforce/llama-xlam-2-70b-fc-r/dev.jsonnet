...
local experiment_code_path = std.extVar("APPWORLD_EXPERIMENT_CODE_PATH");
{
    ...
    "config": {
        "model_server": {
            "command": "vllm serve Salesforce/Llama-xLAM-2-70b-fc-r --max-num-seqs 5 --max-model-len 16000 --served-model-name llama-xLAM-2-70b-fc-r --port {port} --enable-auto-tool-choice --tool-call-parser xlam "  + "--tool-parser-plugin " + experiment_code_path + "/common/vllm_plugins/xlam_tool_call_parser.py ",
            "enabled": true,
            "show_logs": false,
            "timeout": 600
        },
    ...
    "metadata": {
        "model": {
            "file_name": "llama-xlam-2-70b-fc-r",
            "humanized_name": "Llama Xlam 2 70B Fc R",
            "precise_name": "Salesforce/Llama-xLAM-2-70b-fc-r",
            "creator": "salesforce",
            "provider": "vllm",
        },
        "agent": {
