...
local model = {
    ...
    "settings": {
        ...
        "temperature": 0.0,
        "cost_per_token": {"input_cache_hit": 5e-08, "input_cache_miss": 2e-07, "input_cache_write": 0.0, "output": 5e-07},  # NOTE: Not used, need to figure out how to use it.
        "store": false,
    },
    "extras": {},
};
{
    ...
    "metadata": {
        "model": {
            "file_name": "grok-4-fast-non-reasoning",
            "humanized_name": "Grok 4 Fast Non Reasoning",
            "precise_name": "grok-4-fast-non-reasoning",
            "creator": "xai",
            "provider": "xai",
        },
        "agent": {
