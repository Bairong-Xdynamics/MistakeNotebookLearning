...
local model = {
    ...
    "settings": {
        ...
        "temperature": 0.0,
        "cost_per_token": {"input_cache_hit": 7.5e-07, "input_cache_miss": 3e-06, "input_cache_write": 0.0, "output": 1.5e-05},  # NOTE: Not used, need to figure out how to use it.
        "store": false,
    },
    "extras": {},
};
{
    ...
    "metadata": {
        "model": {
            "file_name": "grok-4-0709",
            "humanized_name": "Grok 4 0709",
            "precise_name": "grok-4-0709",
            "creator": "xai",
            "provider": "xai",
        },
        "agent": {
