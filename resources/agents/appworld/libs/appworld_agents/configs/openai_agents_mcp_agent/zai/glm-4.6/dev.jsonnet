...
local model = {
    ...
    "settings": {
        ...
        "temperature": 0.0,
        "seed": 100,
        "cost_per_token": {"input_cache_hit": 1.1e-07, "input_cache_miss": 6e-07, "input_cache_write": 0.0, "output": 2.2e-06},  # NOTE: Not used, need to figure out how to use it.
        "store": false,
    },
    "extras": {},
};
{
    ...
    "metadata": {
        "model": {
            "file_name": "glm-4.6",
            "humanized_name": "Glm 4.6",
            "precise_name": "glm-4.6",
            "creator": "zai",
            "provider": "zai",
        },
        "agent": {
