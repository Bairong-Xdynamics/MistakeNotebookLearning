...
local model = {
    ...
    "settings": {
        ...
        "temperature": 0.0,
        "seed": 100,
        "cost_per_token": {"input_cache_hit": 7.5e-08, "input_cache_miss": 1.5e-07, "input_cache_write": 0.0, "output": 6e-07},  # NOTE: Not used, need to figure out how to use it.
        "store": false,
    },
    "extras": {},
};
{
    ...
    "metadata": {
        "model": {
            "file_name": "gpt-4o-mini-2024-07-18",
            "humanized_name": "Gpt 4O Mini 2024 07 18",
            "precise_name": "gpt-4o-mini-2024-07-18",
            "creator": "openai",
            "provider": "openai",
        },
        "agent": {
