...
local model = {
    ...
    "settings": {
        ...
        "temperature": 0.0,
        "seed": 100,
        "cost_per_token": {"input_cache_hit": 1e-07, "input_cache_miss": 4e-07, "input_cache_write": 0.0, "output": 1.6e-06},  # NOTE: Not used, need to figure out how to use it.
        "store": false,
    },
    "extras": {},
};
{
    ...
    "metadata": {
        "model": {
            "file_name": "gpt-4.1-mini-2025-04-14",
            "humanized_name": "Gpt 4.1 Mini 2025 04 14",
            "precise_name": "gpt-4.1-mini-2025-04-14",
            "creator": "openai",
            "provider": "openai",
        },
        "agent": {
