...
local model = {
    ...
    "settings": {
        ...
        "temperature": 0.0,
        "seed": 100,
        "cost_per_token": {"input_cache_hit": 4e-07, "input_cache_miss": 4e-07, "input_cache_write": 0.0, "output": 1.75e-06},  # NOTE: Not used, need to figure out how to use it.
        "store": false,
    },
    "extras": {},
};
{
    ...
    "metadata": {
        "model": {
            "file_name": "deepseek-r1-0528_openrouter",
            "humanized_name": "Deepseek R1 0528 Openrouter",
            "precise_name": "openrouter/deepseek/deepseek-r1-0528",
            "creator": "deepseek",
            "provider": "openrouter",
        },
        "agent": {
