...
local experiment_code_path = std.extVar("APPWORLD_EXPERIMENT_CODE_PATH");
{
    ...
    "config": {
        "model": {
            ...
            "cost_per_token": {"input_cache_hit": 7.5e-08, "input_cache_miss": 3e-07, "input_cache_write": 0.0, "output": 2.5e-06},  # NOTE: Not used, need to figure out how to use it.
            "use_cache": false,
        },
        "api_predictor": {
            "mode": "predicted",
    ...
    "metadata": {
        "model": {
            "file_name": "gemini-2.5-flash-preview-09-2025-medium-reasoning",
            "humanized_name": "Gemini 2.5 Flash Preview 09 2025 Medium Reasoning",
            "precise_name": "gemini/gemini-2.5-flash-preview-09-2025",
            "creator": "google",
            "provider": "google",
        },
        "agent": {
