...
local experiment_code_path = std.extVar("APPWORLD_EXPERIMENT_CODE_PATH");
{
    ...
    "config": {
        "model": {
            ...
            "cost_per_token": {"input_cache_hit": 5e-08, "input_cache_miss": 5e-08, "input_cache_write": 0.0, "output": 2.5e-07},  # NOTE: Not used, need to figure out how to use it.
            "use_cache": false,
        },
        "api_predictor": {
            "mode": "predicted",
    ...
    "metadata": {
        "model": {
            "file_name": "gpt-oss-120b-medium-reasoning_openrouter",
            "humanized_name": "Gpt Oss 120B Medium Reasoning Openrouter",
            "precise_name": "openrouter/openai/gpt-oss-120b",
            "creator": "openai",
            "provider": "openrouter",
        },
        "agent": {
