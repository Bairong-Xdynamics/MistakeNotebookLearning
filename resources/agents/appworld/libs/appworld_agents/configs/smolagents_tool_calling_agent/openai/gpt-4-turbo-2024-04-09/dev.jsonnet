...
local experiment_code_path = std.extVar("APPWORLD_EXPERIMENT_CODE_PATH");
{
    ...
    "config": {
        "model": {
            ...
            "seed": 100,
            "cost_per_token": {"input_cache_hit": 1e-05, "input_cache_miss": 1e-05, "input_cache_write": 0.0, "output": 3e-05},  # NOTE: Not used, need to figure out how to use it.
            "use_cache": false,
        },
        "api_predictor": {
            "mode": "predicted",
    ...
    "metadata": {
        "model": {
            "file_name": "gpt-4-turbo-2024-04-09",
            "humanized_name": "Gpt 4 Turbo 2024 04 09",
            "precise_name": "gpt-4-turbo-2024-04-09",
            "creator": "openai",
            "provider": "openai",
        },
        "agent": {
