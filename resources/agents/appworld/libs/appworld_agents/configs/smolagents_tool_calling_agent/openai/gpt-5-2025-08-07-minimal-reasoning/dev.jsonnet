...
local experiment_code_path = std.extVar("APPWORLD_EXPERIMENT_CODE_PATH");
{
    ...
    "config": {
        "model": {
            ...
            "cost_per_token": {"input_cache_hit": 1.25e-07, "input_cache_miss": 1.25e-06, "input_cache_write": 0.0, "output": 1e-05},  # NOTE: Not used, need to figure out how to use it.
            "use_cache": false,
        },
        "api_predictor": {
            "mode": "predicted",
    ...
    "metadata": {
        "model": {
            "file_name": "gpt-5-2025-08-07-minimal-reasoning",
            "humanized_name": "Gpt 5 2025 08 07 Minimal Reasoning",
