...
local experiment_code_path = std.extVar("APPWORLD_EXPERIMENT_CODE_PATH");
{
    ...
    "config": {
        "model": {
            ...
            "seed": 100,
            "cost_per_token": {"input_cache_hit": 5e-07, "input_cache_miss": 5e-07, "input_cache_write": 0.0, "output": 6e-06},  # NOTE: Not used, need to figure out how to use it.
            "use_cache": false,
        },
        "api_predictor": {
            "mode": "predicted",
    ...
    "metadata": {
        "model": {
            "file_name": "qwen3-next-80b-a3b-thinking",
            "humanized_name": "Qwen3 Next 80B A3B Thinking",
            "precise_name": "qwen3-next-80b-a3b-thinking",
            "creator": "alibaba",
            "provider": "alibaba",
        },
        "agent": {
