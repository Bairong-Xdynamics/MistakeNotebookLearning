...
local experiment_code_path = std.extVar("APPWORLD_EXPERIMENT_CODE_PATH");
{
    ...
    "config": {
        "model": {
            ...
            "seed": 100,
            "cost_per_token": {"input_cache_hit": 4e-07, "input_cache_miss": 4e-07, "input_cache_write": 0.0, "output": 2.2e-06},  # NOTE: Not used, need to figure out how to use it.
            "use_cache": false,
        },
        "api_predictor": {
            "mode": "predicted",
    ...
    "metadata": {
        "model": {
            "file_name": "minimax-m1",
            "humanized_name": "Minimax M1",
            "precise_name": "MiniMax-M1",
            "creator": "minimax",
            "provider": "minimax",
        },
        "agent": {
