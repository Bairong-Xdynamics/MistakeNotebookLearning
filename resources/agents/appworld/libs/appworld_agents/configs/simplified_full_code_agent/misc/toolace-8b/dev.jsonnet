...
local demo_task_ids = ["82e2fac_1", "29caf6f_1", "d0b1f43_1"];
{
    ...
    "config": {
        "model_server": {
            "command": "vllm serve Team-ACE/ToolACE-8B --max-num-seqs 5 --enable-auto-tool-choice --tool-call-parser pythonic --port {port}",
            "enabled": true,
            "show_logs": false,
            "timeout": 600
        },
    ...
    "metadata": {
        "model": {
            "file_name": "toolace-8b",
            "humanized_name": "Toolace 8B",
            "precise_name": "Team-ACE/ToolACE-8B",
            "creator": "misc",
            "provider": "vllm",
        },
        "agent": {
