...
local demo_task_ids = ["82e2fac_1", "29caf6f_1", "d0b1f43_1"];
{
    ...
    "config": {
        "model_server": {
            "command": "vllm serve Qwen/Qwen2.5-7B-Instruct --max-num-seqs 5 --max-model-len 32000 --enable-auto-tool-choice --tool-call-parser hermes --port {port}",
            "enabled": true,
            "show_logs": false,
            "timeout": 600
        },
    ...
    "metadata": {
        "model": {
            ...
            "humanized_name": "Qwen2.5 7B Instruct",
            "precise_name": "Qwen/Qwen2.5-7B-Instruct",
            "creator": "alibaba",
            "provider": "vllm",
        },
        "agent": {
