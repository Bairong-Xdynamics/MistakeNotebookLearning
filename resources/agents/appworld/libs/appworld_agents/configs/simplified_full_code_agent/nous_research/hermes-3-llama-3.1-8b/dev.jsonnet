...
local demo_task_ids = ["82e2fac_1", "29caf6f_1", "d0b1f43_1"];
{
    ...
    "config": {
        "model_server": {
            "command": "vllm serve NousResearch/Hermes-3-Llama-3.1-8B --max-num-seqs 5 --enable-auto-tool-choice --tool-call-parser hermes --port {port}",
            "enabled": true,
            "show_logs": false,
            "timeout": 600
        },
    ...
    "metadata": {
        "model": {
            "file_name": "hermes-3-llama-3.1-8b",
            "humanized_name": "Hermes 3 Llama 3.1 8B",
            "precise_name": "NousResearch/Hermes-3-Llama-3.1-8B",
            "creator": "nous_research",
            "provider": "vllm",
        },
        "agent": {
